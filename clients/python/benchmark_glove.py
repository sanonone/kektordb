...
INDEX_NAME = "glove-6B-50d-benchmark"
...
def main():
    ...
    # 3. Inserisci i dati
    print(f"Inserimento di {num_vectors} vettori in KektorDB...")
    start_time = time.time()
    for i, vec in enumerate(tqdm(vectors)):
        # Usiamo la parola come ID
        client.vadd(INDEX_NAME, words[i], vec.tolist())
