...
func TestVectorizerProcessing(t *testing.T) {
	...
	if err := eng.VCreate(indexName, distance.Cosine, 16, 200, distance.Float32, "english", nil, nil, nil, false, 0); err != nil {
...
func TestVectorizerConcurrent(t *testing.T) {
	...
	for i := 0; i < numVectorizers; i++ {
		...
		eng.VCreate(idxName, distance.Cosine, 16, 200, distance.Float32, "", nil, nil, nil, false, 0)
